...
import { Home, Search, Receipt, User, ShoppingCart, Moon, Sun, Menu, X, Settings, Shield, MapPin, Clock, Truck } from 'lucide-react'; اعد كتابه الكود بالكامل مع الحل 
...
                  <span className="text-xs">{itm.label}</span>
                </Button>
              );
            })}
          </div>
